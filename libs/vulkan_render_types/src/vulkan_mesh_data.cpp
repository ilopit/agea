...
get_vertex_description()
{
    ...
    main_binding.stride = sizeof(gpu_vertex_data);
    ...
    position_attribute.offset = offsetof(gpu_vertex_data, position);
    ...
    normal_attribute.offset = offsetof(gpu_vertex_data, normal);
    ...
    color_attribute.offset = offsetof(gpu_vertex_data, color);
    ...
    uv_attribute.offset = offsetof(gpu_vertex_data, uv);
