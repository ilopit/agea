...
// boundary are not split. Interior faces exposed by the fracture are not
// capped; chunks are therefore open shells of the source surface. This matches
// the offline pre-fracture step of UE's destructible mesh pipeline; a follow-up
// pass can add convex-cell clipping and interior face generation.
//
