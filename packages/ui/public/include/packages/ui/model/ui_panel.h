...
// Property accessors (get_color/get_opacity + setters) are generated by argen
// into ui_panel.ar.h.
// clang-format off
KRG_ar_class(render_cmd_builder   = ui_panel__cmd_builder,
             render_cmd_destroyer = ui_panel__cmd_destroyer);
class ui_panel : public ::kryga::root::ui_widget
// clang-format on
{
    KRG_gen_meta__ui_panel();

public:
    KRG_gen_class_meta(ui_panel, ::kryga::root::ui_widget);
