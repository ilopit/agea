...
#include "packages/root/model/simple_texture_material.ar.h"
...
protected:
    AGEA_ar_property("category=Properties",
                     "serializable=true",
                     "property_des_handler=texture_sample_deserialize",
                     "property_ser_handler=texture_sample_serialize",
                     "property_prototype_handler=texture_sample_prototype",
                     "property_compare_handler=texture_sample_compare",
                     "property_copy_handler=texture_sample_copy");
