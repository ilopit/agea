...
result_code color__save(reflection::type_save_context& ctx);
result_code color__load(reflection::type_load_context& ctx);
result_code color__copy(reflection::type_copy_context& ctx);
result_code color__to_string(reflection::type_ui_context& ctx);

result_code buffer__save(reflection::type_save_context& ctx);
result_code buffer__load(reflection::type_load_context& ctx);
result_code buffer__copy(reflection::type_copy_context& ctx);
result_code buffer__to_string(reflection::type_ui_context& ctx);

result_code id__save(reflection::type_save_context& ctx);
result_code id__load(reflection::type_load_context& ctx);
...
result_code smart_obj__load(reflection::type_load_context& ctx);
result_code smart_obj__save(reflection::type_save_context& ctx);
result_code smart_obj__to_string(reflection::type_ui_context& ctx);

result_code texture_sample__save(reflection::type_save_context& ctx);
...
result_code texture_sample__load(reflection::type_load_context& ctx);

result_code vec2__to_string(reflection::type_ui_context& ctx);

result_code vec3__save(reflection::type_save_context& ctx);
result_code vec3__load(reflection::type_load_context& ctx);
