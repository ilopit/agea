...
result_code property_layer_mask__save(reflection::property_context__save& dc);
result_code property_layer_mask__compare(reflection::property_context__compare& ctx);
result_code property_layer_mask__load(reflection::property_context__load& ctx);
