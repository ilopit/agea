...
KRG_ar_class(render_cmd_builder    = spot_light_component__cmd_builder,
             ...
             mcp_hint             = "Spot light parameters — colors / direction / radius and inner/outer cone angles in degrees");
...
protected:
    ...
    KRG_ar_property("category=Light Properties", "access=all", "serializable=true",
                    "invalidates=render", "mcp_hint=spot light aim direction [normalized]");
    ...
    KRG_ar_property("category=Light Properties", "access=all", "serializable=true",
                    "invalidates=render", "mcp_hint=inner cone angle in degrees — full brightness inside this");
    float m_cut_off = 17.0f;

    KRG_ar_property("category=Light Properties", "access=all", "serializable=true",
                    "invalidates=render", "mcp_hint=outer cone angle in degrees — light fades between cut_off and this");
