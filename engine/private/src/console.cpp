...
const config_var config_vars_arr[] = {
    ...
    make_var<&rcfg::shadows, &rcfg::shadow_cfg::pcss_light_size>("shadows.pcss_light_size"),
    make_var<&rcfg::shadows, &rcfg::shadow_cfg::pcss_bias>("shadows.pcss_bias"),
    make_var<&rcfg::shadows, &rcfg::shadow_cfg::pcss_normal_bias>("shadows.pcss_normal_bias"),
