...
namespace model
{
class camera_component : public level_object_component
{
public:
    AGEA_gen_class_meta(camera_component, level_object_component);
    ...
    void set_rotation_speed(float rs);
    void set_movement_speed(float ms);
