...
VkFramebufferCreateInfo framebuffer_create_info(VkRenderPass render_pass, VkExtent2D extent);
...
VkRenderPassBeginInfo renderpass_begin_info(VkRenderPass render_pass,
                                            VkExtent2D extent,
...
VkPipelineDepthStencilStateCreateInfo depth_stencil_create_info(bool depth_test,
                                                                bool depth_trite,
