...
{{
    ::agea::reflection::property_type_copy_handlers::init();
    ::agea::reflection::property_type_serialization_handlers::init();
    ::agea::reflection::property_type_serialization_update_handlers::init();
    ::agea::reflection::property_type_compare_handlers::init();
...
{{
    ...
    p->type                           = ::agea::reflection::type_resolver::resolve<decltype(type::m_{property})>();
    p->types_compare_handler          = ::agea::reflection::property_type_compare_handlers::compare_handlers()[(size_t)p->type.type];\n
    // Extra fields
"""
...
def write_properties(context: file_context, prop: agea_property, current_class: agea_class, module_name: str):
    ...
    if prop.serializable == "true":
        ...
        context.content += "    "
        context.content += 'p->types_serialization_handler    = ::agea::reflection::property_type_serialization_handlers::serializers()[(size_t)p->type.type];\n'
        context.content += "    "
        context.content += 'p->types_deserialization_handler  = ::agea::reflection::property_type_serialization_handlers::deserializers()[(size_t)p->type.type];\n'
    ...
    if prop.copyable != "no":
        context.content += "    "
        context.content += 'p->types_copy_handler             = ::agea::reflection::property_type_copy_handlers::copy_handlers()[(size_t)p->type.type];\n'

    if prop.updatable != "no":
        context.content += "    "
        context.content += 'p->types_update_handler           = ::agea::reflection::property_type_serialization_update_handlers::deserializers()[(size_t)p->type.type];\n'
