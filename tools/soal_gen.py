...
{{
    ...
    p->types_compare_handler          = property_compare_handlers::compare_handlers()[(size_t)p->type.type];\n
    // Extra fields
"""
    ...
    while i != lines_count:
        ...
        if line.startswith("AGEA_property"):
            ...
            if prop.serializable == "true":
                ser_handler = "property_serialization_handlers::serializers()[(size_t)p->type.type]" if prop.type_ser_handler == "" else prop.type_ser_handler
                des_handler = "property_serialization_handlers::deserializers()[(size_t)p->type.type]" if prop.type_des_handler == "" else prop.type_des_handler
                context.content += "    "
            ...
            if prop.copyable != "no":
                context.content += "    "
                context.content += 'p->types_copy_handler             = property_copy_handlers::copy_handlers()[(size_t)p->type.type];\n'
            ...
            if prop.updatable != "no":
                context.content += "    "
                context.content += 'p->types_update_handler           = property_serialization_update_handlers::deserializers()[(size_t)p->type.type];\n'
